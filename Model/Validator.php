...
class Validator
{
    ...
    {
        $messages = [
            'x-missing-response'     => 'please complete the security field or wait a few seconds before submitting the form.',
            'x-missing-secret-key'   => 'unable to validate the form, the secret key is missing.',
            'x-unavailable'          => 'unable to contact CaptchaFox to validate the form.',
